...
def recommend_recipes(user_ingredients, top_n=5):
    ...
    def score(recipe_ingredients):
        ...
        # count how many user ingredients appear in recipe
    ...
    if best_score == 0:
        ...
        for ing in user_ingredients:
            # If any top recipe contains this ingredient, consider it matched
